...
__all__ = [
    'SVEVoiceChange', 'DISPID_SRSetPropertyNumber', 'SVSFUnusedFlags',
    'DISPID_SPELexicalForm', 'SpeechAllElements',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVAudioOutput',
    'SPSHT_OTHER', 'DISPID_SPAsItem', 'SpeechCategoryVoices',
    'DISPID_SPRDisplayAttributes', 'SVP_15', 'STCRemoteServer',
    'Speech_Default_Weight', 'SSFMOpenReadWrite', 'SpStream',
    'eLEXTYPE_PRIVATE15', 'SpeechPropertyAdaptationOn', 'SLODynamic',
    'SPVISEMES', 'SASPause', 'SPFM_CREATE_ALWAYS', 'SP_VISEME_13',
    'SP_VISEME_20', 'DISPID_SPCPhoneToId', 'SPPS_RESERVED3',
    'DISPID_SGRSAddWordTransition', 'DISPID_SVSInputWordPosition',
    'DISPID_SVSInputSentenceLength', 'SPEI_END_SR_STREAM',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRCEPhraseStart',
    'SITooQuiet', 'SAFT12kHz16BitMono', 'DISPID_SPRuleChildren',
    'SVF_Stressed', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCERecognition',
    'DISPID_SPRs_NewEnum', 'SSFMOpenForRead', 'SPEVENTENUM',
    'ISpeechFileStream', 'DISPID_SAFType', 'SPAR_High',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SVEStreamStart',
    'DISPID_SADefaultFormat', 'SREFalseRecognition',
    'DISPID_SFSClose', 'DISPID_SRCRecognizer', 'DISPID_SRRAudio',
    'SAFT44kHz8BitStereo', 'SPINTERFERENCE',
    'SpeechTokenIdUserLexicon', 'eLEXTYPE_RESERVED8',
    'DISPID_SPRulesItem', 'SPVPRI_NORMAL', 'SGRSTTDictation',
    'SVEStartInputStream', 'ISpeechGrammarRuleStateTransitions',
    'SITooFast', 'SpeechPropertyResourceUsage',
    'DISPID_SVSpeakCompleteEvent', 'SP_VISEME_0',
    'DISPID_SVEStreamEnd', 'DISPID_SRCVoice', 'eLEXTYPE_PRIVATE5',
    'SPAS_CLOSED', 'ISpeechGrammarRuleState', 'ISpRecoCategory',
    'SREPrivate', 'SECHighConfidence', 'SPEI_MAX_SR',
    'DISPID_SGRClear', 'DISPID_SPPNumberOfElements',
    'SpeechRecoProfileProperties', 'SPDKL_CurrentConfig',
    'SpeechTokenContext', 'ISpeechPhoneConverter', 'SVSFParseMask',
    'SpeechEngineProperties', 'SP_VISEME_9',
    'SDA_Consume_Leading_Spaces', 'DISPID_SAFSetWaveFormatEx',
    'SPSERIALIZEDRESULT', 'DISPID_SABIMinNotification', 'SGRSTTRule',
    'SpeechAudioProperties', 'ISpeechRecoGrammar',
    'SDA_No_Trailing_Space', 'SPEI_SR_AUDIO_LEVEL',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRDisplayUI',
    'SSTTDictation', 'WAVEFORMATEX', 'DISPIDSPTSI',
    'DISPID_SOTCDefault', 'DISPID_SABIEventBias',
    'eLEXTYPE_LETTERTOSOUND', 'SVF_None', 'DISPID_SRGetRecognizers',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRCAudioInInterferenceStatus',
    'eLEXTYPE_PRIVATE9', 'SRCS_Enabled', 'SPEI_RESERVED5',
    'SP_VISEME_4', 'SLTApp', 'SRADefaultToActive', 'SPBO_PAUSE',
    'DISPID_SGRSAddSpecialTransition', 'Speech_StreamPos_Asap',
    'ISpSerializeState', 'SPINTERFERENCE_NOISE',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPILanguageId',
    'SpObjectToken', 'DISPID_SRCESoundEnd', 'SRARoot',
    ...
    'SAFTADPCM_11kHzStereo', 'eLEXTYPE_RESERVED9',
    'eLEXTYPE_RESERVED6', 'SSFMCreateForWrite', 'SSFMCreate',
    'SPEI_SR_PRIVATE', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRCCreateResultFromMemory', 'SpeechRecognitionType',
    'SPBOOKMARKOPTIONS', 'DISPID_SVSInputWordLength', 'SVP_16',
    'DISPID_SVAlertBoundary', 'tagSPPROPERTYINFO',
    'SPINTERFERENCE_TOOQUIET', 'ISpGrammarBuilder', 'SASClosed',
    'eWORDTYPE_DELETED', 'SP_VISEME_19', 'SP_VISEME_21',
    'DISPID_SVSpeak', 'SAFT22kHz8BitMono', 'DISPID_SPIGrammarId',
    'ISpeechLexiconWords', 'SSTTTextBuffer', 'STCInprocServer',
    ...
    'SWPUnknownWordPronounceable', 'SVP_19', 'DISPID_SPIRule',
    'SDTReplacement', 'SPBO_TIME_UNITS', 'SPBO_NONE',
    'SECNormalConfidence', 'SpeechAudioFormatGUIDWave',
    'SREStreamStart', 'SPWORDPRONUNCIATIONLIST', 'ISpeechDataKey',
    'SPWF_SRENGINE', 'DISPID_SVEBookmark', 'SVSFParseAutodetect',
    'SPSEMANTICFORMAT', 'DISPID_SOTsCount', 'DISPID_SPPFirstElement',
    'SAFT12kHz16BitStereo', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPRuleName', 'eLEXTYPE_PRIVATE11', 'STSF_FlagCreate',
    'SpUnCompressedLexicon', 'SPCATEGORYTYPE', 'SAFT44kHz16BitStereo',
    'LONG_PTR', 'SPPS_Verb', 'IInternetSecurityMgrSite',
    'SpeechWordType', 'DISPID_SVEAudioLevel', 'DISPID_SPPChildren',
    'DISPID_SASState', 'SPRS_ACTIVE', 'SPSHORTCUTTYPE',
    'SpeechAddRemoveWord', 'SP_VISEME_3', 'DISPID_SpeechMMSysAudio',
    'SVP_11', 'DISPID_SPIAudioSizeTime', 'SpeechTokenKeyUI',
    'DISPID_SRRTOffsetFromStart', 'eLEXTYPE_APP',
    'ISpeechTextSelectionInformation', 'DISPID_SPRFirstElement',
    'SLOStatic', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SpeechObjectTokens', 'SVP_0', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRCRetainedAudioFormat', 'SPEI_VISEME',
    'ISpXMLRecoResult', 'DISPID_SMSADeviceId',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SLGetWords',
    'SRAImport', 'ISpeechXMLRecoResult', 'SREInterference',
    'SPPROPERTYINFO', 'DISPID_SPERetainedSizeBytes',
    'SpPhraseInfoBuilder', 'DISPID_SPEAudioSizeTime',
    'DISPID_SRSClsidEngine', 'ISpRecoResult', 'SP_VISEME_10',
    'DISPID_SPPId', 'ISpeechRecognizer', 'ISpStreamFormatConverter',
    'SpeechEngineConfidence', 'eLEXTYPE_PRIVATE8', 'SVSFIsXML',
    'ISpeechRecoResultTimes', 'DISPID_SDKEnumValues',
    'DISPID_SDKSetBinaryValue', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRCBookmark', 'SPEVENTSOURCEINFO', 'DISPID_SOTSetId',
    'DISPID_SPPParent', 'SBONone',
    'DISPID_SPANumberOfElementsInResult', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRRAlternates', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SVSkip', 'SVEAudioLevel', 'STSF_CommonAppData',
    'SPPHRASEELEMENT', 'SPWORDTYPE', 'DISPID_SVSRunningState',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SGRId', 'SFTInput',
    'DISPID_SPAPhraseInfo', 'SPSVerb', 'DISPID_SASetState',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SRAORetainAudio',
    'ISpeechGrammarRules', 'SPCT_SLEEP', 'SVSFNLPMask',
    'DISPID_SBSFormat', 'SAFTCCITT_uLaw_8kHzMono',
    'eLEXTYPE_PRIVATE12', 'DISPID_SGRsCommit', 'DISPID_SAEventHandle',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechPhraseProperties', 'SPWORD',
    'SREPropertyStringChange', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPRNumberOfElements', 'DISPID_SRGCmdLoadFromMemory',
    'ISpeechBaseStream', 'DISPID_SVEPhoneme', 'DISPID_SRRRecoContext',
    'DISPID_SRRTStreamTime', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechPropertyResponseSpeed', 'SPCS_DISABLED',
    'SpeechDictationTopicSpelling', 'DISPID_SOTIsUISupported',
    'SDTAll', 'DISPID_SOTGetStorageFileName', 'DISPID_SDKOpenKey',
    'SPAS_STOP', 'DISPID_SRAudioInputStream',
    'DISPID_SLRemovePronunciation', 'SAFT22kHz16BitStereo',
    'DISPID_SBSSeek', 'DISPID_SPPValue', 'SPINTERFERENCE_TOOLOUD',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SPRuleId', 'DISPID_SRAudioInput', 'DISPID_SRProfile',
    'eLEXTYPE_PRIVATE17', 'DISPID_SGRSTNextState',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPSEMANTICERRORINFO',
    'DISPID_SDKGetlongValue', 'DISPID_SpeechMemoryStream',
    'SPGS_ENABLED', 'SpeechTokenValueCLSID', 'SVF_Emphasis',
    'SVSFIsFilename', 'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SpeechVoice',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SPAs_NewEnum', 'SPSLMA', 'SVPAlert', 'SGDSInactive',
    'SVP_20', 'SPSHT_Unknown', 'DISPID_SPIGetText',
    'SpeechVoiceSpeakFlags', 'DISPID_SVSVisemeId',
    'DISPID_SGRSTPropertyId', 'SVEPhoneme', 'SAFTADPCM_22kHzStereo',
    'SPPS_Unknown', 'DISPID_SPRulesCount',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SpeechPhraseBuilder',
    'SVEAllEvents', 'SPEI_START_SR_STREAM',
    'DISPID_SGRSAddRuleTransition', 'SGRSTTWord', 'SPEI_RESERVED3',
    'DISPID_SVVoice', 'SPPS_Modifier', 'DISPID_SVGetVoices',
    'DISPID_SVResume', 'SSSPTRelativeToStart', 'SpCompressedLexicon',
    'SRTReSent', 'DISPIDSPTSI_ActiveLength', 'SGSExclusive',
    'SDKLCurrentUser', 'DISPID_SpeechPhoneConverter',
    'Speech_Max_Pron_Length', 'STCAll', 'SPRECORESULTTIMES',
    'DISPID_SpeechPhraseElements', 'ISpeechLexicon', 'SP_VISEME_15',
    'DISPID_SVSLastBookmark', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPRules_NewEnum', 'SpMMAudioEnum', 'SpeechInterference',
    'SPSHT_EMAIL', 'SVP_4', 'SpeechPropertyComplexResponseSpeed',
    'ISpObjectWithToken', 'DISPID_SGRSTsItem', 'SpeechRuleAttributes',
    'DISPID_SABufferNotifySize', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpObjectTokenCategory', 'SpNullPhoneConverter',
    'DISPID_SRSetPropertyString', 'DISPID_SVGetAudioInputs',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_PRIVATE14', 'tagSTATSTG',
    'SAFTADPCM_8kHzMono', 'DISPID_SGRsAdd', 'SAFT22kHz16BitMono',
    'ISpStream', 'SAFTCCITT_uLaw_22kHzMono',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpRecoGrammar2',
    'DISPID_SRRSpeakAudio', 'SPEI_UNDEFINED', 'SSTTWildcard',
    'SAFT12kHz8BitStereo', 'eLEXTYPE_PRIVATE10',
    'DISPID_SGRInitialState', 'SRSEDone', 'DISPID_SLPs_NewEnum',
    'SPDKL_LocalMachine', 'SpeechVisemeType', 'ISpeechRecoResult',
    'SPCS_ENABLED', 'SPEI_TTS_PRIVATE', 'SpeechTokenShellFolder',
    'DISPID_SMSGetData', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'eLEXTYPE_PRIVATE4', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPPEngineConfidence', 'SPRST_NUM_STATES',
    'DISPID_SDKSetStringValue', 'SAFT12kHz8BitMono',
    'DISPID_SGRSTPropertyValue', 'SpeechCategoryPhoneConverters',
    'DISPID_SVIsUISupported', 'IEnumSpObjectTokens',
    'SPPS_Interjection', 'DISPID_SGRSTType',
    'DISPID_SpeechBaseStream', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SGRSRule', 'SpeechGrammarTagDictation',
    'SpeechAudioVolume', 'SITooSlow', 'DISPID_SpeechDataKey',
    'ISpRecoContext2', 'SITooLoud', 'ISpProperties',
    'SpeechCategoryRecoProfiles', 'SAFT24kHz8BitMono', 'SVP_17',
    'STCLocalServer', 'SWTDeleted', 'SRTEmulated', 'SGRSTTTextBuffer',
    'Speech_Max_Word_Length', 'SpeechRecognizerState', 'SP_VISEME_8',
    'DISPID_SLPsCount', 'DISPID_SPEs_NewEnum', 'STSF_LocalAppData',
    'SREBookmark', 'SPSTREAMFORMATTYPE', 'ISpeechObjectTokenCategory',
    'SVP_9', 'SPRS_ACTIVE_USER_DELIMITED', 'SINoSignal',
    'SpeechVoiceEvents', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPLO_STATIC',
    'SAFT11kHz16BitMono', 'SpeechGrammarWordType', 'SPEI_RESERVED6',
    'DISPID_SLWs_NewEnum', 'ISpeechPhraseAlternate',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRCERecognizerStateChange',
    'SPSNoun', 'SpPhoneticAlphabetConverter',
    'DISPID_SOTCreateInstance', 'SpeechRetainedAudioOptions',
    'SPEI_REQUEST_UI', 'DISPID_SLGenerationId', 'ISpeechPhraseInfo',
    'ISpeechVoiceStatus', 'SDTAlternates', 'SpLexicon',
    'SpeechCategoryRecognizers', 'SGPronounciation', 'SpWaveFormatEx',
    'DISPID_SGRsCount', 'SDTPronunciation', 'SVEEndInputStream',
    'DISPID_SpeechRecoContext', 'DISPID_SpeechPhraseRule',
    'SVSFVoiceMask', 'DISPID_SPEsCount', 'DISPID_SGRsDynamic',
    'SPPHRASEPROPERTY', 'DISPID_SDKGetStringValue', 'SPEI_MIN_TTS',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPIElements', 'SRESoundEnd', 'SPEI_RESERVED1',
    'SRTExtendableParse', 'SPEI_HYPOTHESIS', 'ISpeechPhraseProperty',
    'SPWT_LEXICAL', 'ISpeechPhraseElement', 'DISPID_SGRAttributes',
    'DISPID_SVSLastResult', 'DISPID_SAFGuid', 'SRADynamic',
    'DISPID_SRCEAudioLevel', 'ISpEventSource', 'SRTStandard',
    'SPWORDPRONUNCIATION', 'SpeechGrammarTagWildcard',
    'SPPS_RESERVED1', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SOTDisplayUI',
    'DISPID_SRGCmdSetRuleState', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRCEventInterests', 'SpeechCategoryAudioIn',
    'SPSModifier', 'SVEViseme', 'ISpeechCustomStream',
    'eLEXTYPE_PRIVATE13', 'DISPID_SOTRemove', 'SVP_3',
    'DISPID_SDKEnumKeys', 'ISpeechMMSysAudio',
    'ISpeechRecognizerStatus', 'SAFT32kHz8BitStereo',
    'SECFIgnoreWidth', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPRuleFirstElement', 'SP_VISEME_18', 'SAFT44kHz16BitMono',
    'DISPID_SpeechAudioBufferInfo', 'ISpRecoGrammar',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SPPsItem',
    'SpInProcRecoContext', 'DISPID_SWFEAvgBytesPerSec', 'SP_VISEME_5',
    'SpeechRecoContextState', 'DISPID_SVWaitUntilDone',
    'SPCT_COMMAND', 'SVP_13', 'IEnumString', 'DISPIDSPRG',
    'SWPUnknownWordUnpronounceable', 'SGSDisabled', 'SPPHRASE',
    'DISPID_SPPName', 'ISpeechVoice', 'DISPID_SAVolume', 'ISpVoice',
    'SP_VISEME_14', 'DISPID_SREmulateRecognition', 'SPRULESTATE',
    'SpeechSpecialTransitionType',
    'SpeechPropertyLowConfidenceThreshold', 'SPXRO_SML',
    'SPPS_NotOverriden', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SRCCreateGrammar', 'DISPID_SOTCEnumerateTokens',
    'SRESoundStart', 'DISPID_SRGId', 'SpeechLoadOption', 'SVP_1',
    'DISPID_SpeechWaveFormatEx', 'SpAudioFormat', 'SVP_10',
    'SDTLexicalForm', 'SPAR_Unknown', 'DISPID_SAStatus',
    'DISPID_SPIRetainedSizeBytes',
    'SpeechPropertyHighConfidenceThreshold',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPBINARYGRAMMAR',
    'SP_VISEME_7', 'DISPID_SPCLangId', 'DISPID_SRRGetXMLResult',
    'SpeechBookmarkOptions', 'ISequentialStream',
    'DISPID_SLPPhoneIds', 'ISpeechPhraseReplacement',
    'DISPID_SPEDisplayText', 'SPDKL_CurrentUser', 'SpFileStream',
    'DISPID_SRRSaveToMemory', 'DISPID_SPRsItem', 'SRATopLevel',
    'SASRun', 'ISpeechRecoResultDispatch',
    'DISPID_SpeechPhraseElement', 'SPXMLRESULTOPTIONS', 'SRSActive',
    'DISPID_SRCState', 'DISPID_SPISaveToMemory', 'DISPID_SPAsCount',
    'DISPID_SGRSTRule', 'DISPID_SPRText', 'SPEI_MAX_TTS',
    'DISPID_SWFESamplesPerSec', 'ISpeechObjectToken',
    'eWORDTYPE_ADDED', 'ISpMMSysAudio', 'SAFTExtendedAudioFormat',
    'SDTRule', 'SpVoice', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRRSetTextFeedback', 'SECFIgnoreCase',
    'DISPID_SPIEngineId', 'DISPID_SRGCmdLoadFromObject',
    'SpeechAudioState', 'SPVPRIORITY', 'SPGRAMMARWORDTYPE',
    'SGLexicalNoSpecialChars', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRRPhraseInfo', 'SPVOICESTATUS',
    'DISPID_SRCSetAdaptationData', 'SPEI_SENTENCE_BOUNDARY',
    'SPBO_AHEAD', 'SVSFNLPSpeakPunc', 'DISPID_SGRSTransitions',
    'SAFTGSM610_8kHzMono', 'SPEI_MIN_SR', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPWORDLIST',
    'SpTextSelectionInformation', 'ISpRecognizer3',
    'DISPID_SRSNumberOfActiveRules', 'SPRS_INACTIVE',
    'DISPID_SGRsFindRule', 'ISpShortcut', 'ISpStreamFormat',
    'DISPID_SVEVoiceChange', 'SAFT11kHz8BitMono', 'SPAO_RETAIN_AUDIO',
    'SVP_5', 'SPFM_NUM_MODES', 'SVSFPurgeBeforeSpeak',
    'SRERecognition', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPSFunction', 'SREAudioLevel', 'DISPID_SVSpeakStream',
    'DISPID_SpeechGrammarRules', 'DISPID_SVDisplayUI',
    'SPSHT_NotOverriden', 'DISPID_SLGetPronunciations',
    'SPEI_FALSE_RECOGNITION', 'STSF_AppData',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_PRIVATE20',
    'SPEI_ADAPTATION', 'SREAllEvents', 'SpeechCategoryAudioOut',
    'DISPID_SRRecognizer', 'SpeechDataKeyLocation',
    'SpeechGrammarState', 'ISpNotifySink', 'SVP_18',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechRecoEvents', 'SVP_21',
    'DISPID_SVESentenceBoundary', 'DISPID_SPPsCount',
    'DISPID_SLWsItem', 'DISPID_SRGReset', 'ISpeechPhraseProperties',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRGCmdLoadFromResource',
    'SPPHRASERULE', 'SPFM_OPEN_READWRITE', 'SVP_6', 'DISPID_SPEsItem',
    ...
    'SPAUDIOSTATUS', 'SPRECOSTATE', 'SPPARTOFSPEECH',
    'DISPID_SRIsUISupported', 'SPRECOCONTEXTSTATUS', 'SGSEnabled',
    'ISpeechPhraseRule', 'DISPID_SVSPhonemeId', 'SPCT_SUB_DICTATION',
    'SSSPTRelativeToEnd', 'DISPID_SBSRead', 'SP_VISEME_17',
    'SpResourceManager', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRGRules', 'SVESentenceBoundary',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SLWsCount', '_SPAUDIOSTATE',
    'SPWT_PRONUNCIATION', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRIsShared',
    'SAFT8kHz8BitMono', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPCIdToPhone',
    'SP_VISEME_11', 'DISPID_SLPLangId', 'SWPKnownWordPronounceable',
    'SPAUDIOOPTIONS', 'SAFT24kHz16BitMono',
    'DISPID_SRGIsPronounceable', 'DISPID_SpeechLexiconPronunciation',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPEActualConfidence',
    'SPSInterjection', 'SPGRAMMARSTATE', 'SPLO_DYNAMIC', 'SASStop',
    'DISPID_SRCERequestUI', 'IInternetSecurityManager',
    'SGRSTTWildcard', 'SAFT48kHz8BitMono', 'SGDSActive',
    'SpPhoneConverter', 'SAFT48kHz16BitMono',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPDKL_DefaultLocation',
    'SPEI_RESERVED2', 'DISPID_SGRSTsCount', 'SPLOADOPTIONS',
    'DISPID_SOTDataKey', 'SPPS_Noun', 'DISPID_SGRSTText', 'SRAONone',
    'SPWAVEFORMATTYPE', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SVEventInterests', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRCEAdaptation', 'DISPID_SRGDictationLoad',
    'ISpNotifyTranslator', 'SDTDisplayText', 'SPCT_SUB_COMMAND',
    'DISPID_SRSAudioStatus', 'DISPID_SOTGetDescription',
    'ISpPhoneticAlphabetConverter', 'ISpObjectToken',
    'SPEI_RECOGNITION', 'DISPID_SPRuleParent', 'ISpRecoContext',
    'eLEXTYPE_RESERVED4', 'DISPID_SpeechRecoResult2',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSInputSentencePosition', 'DISPID_SLPSymbolic',
    'SAFT32kHz8BitMono', 'DISPID_SRRTimes', 'eLEXTYPE_PRIVATE19',
    'DISPID_SLWLangId', 'DISPID_SpeechRecoResult',
    'SAFT16kHz16BitStereo', 'SPFILEMODE', 'DISPID_SVGetProfiles',
    'STCInprocHandler', 'DISPID_SGRSTWeight',
    'DISPID_SpeechCustomStream', 'SPEI_PHONEME', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPEEngineConfidence', 'DISPID_SLWType', 'SPEI_SOUND_END',
    'DISPID_SPAStartElementInResult', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SWFEExtraData', 'SVP_12', 'DISPID_SPRsCount',
    'SVSFPersistXML', 'DISPID_SBSWrite', 'SPGS_DISABLED',
    'DISPID_SGRs_NewEnum', 'SAFT8kHz8BitStereo', 'SPAS_PAUSE',
    'SRERequestUI', '_ISpeechVoiceEvents', 'DISPID_SOTs_NewEnum',
    'eLEXTYPE_USER_SHORTCUT', 'SPRST_ACTIVE',
    'DISPID_SpeechLexiconWord',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SVRate',
    'SPADAPTATIONRELEVANCE', 'SAFT44kHz8BitMono', 'SpeechRuleState',
    'DISPID_SPIProperties', 'ISpeechPhraseReplacements',
    'SREHypothesis', 'DISPID_SRRTTickCount',
    ...
    'SpMMAudioOut', 'DISPID_SOTCGetDataKey', 'SAFTGSM610_11kHzMono',
    'DISPID_SLAddPronunciation', 'SDA_Two_Trailing_Spaces',
    'ISpeechPhraseAlternates', 'SpShortcut', 'SpeechVisemeFeature',
    'SPEI_INTERFERENCE', 'ISpeechAudioStatus', 'SRSEIsSpeaking',
    'DISPID_SpeechPhraseRules', 'SpeechCategoryAppLexicons',
    'SPEI_SR_BOOKMARK', 'SPSHORTCUTPAIRLIST', 'DISPID_SPACommit',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechGrammarRule',
    'ISpDataKey', 'DISPID_SpeechPhraseProperty', 'SPEVENT',
    'DISPID_SLPType', 'DISPID_SRGetPropertyNumber',
    'SAFT8kHz16BitStereo', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRGCommit', 'SpeechDisplayAttributes',
    'DISPID_SpeechVoiceEvent', 'SAFTNonStandardFormat',
    'SAFT48kHz16BitStereo', 'IStream', 'SVEPrivate', 'SECFDefault',
    'SPDATAKEYLOCATION', 'DISPID_SMSAMMHandle', 'SREAdaptation',
    'eLEXTYPE_VENDORLEXICON', 'SP_VISEME_16', 'eLEXTYPE_PRIVATE16',
    'eLEXTYPE_RESERVED10', 'SP_VISEME_1', 'SP_VISEME_2',
    'ISpeechAudioFormat', 'DISPID_SVEEnginePrivate',
    'SpeechAudioFormatGUIDText', 'SpMemoryStream',
    '__MIDL_IWinTypes_0009', 'tagSPTEXTSELECTIONINFO', 'SPAUDIOSTATE',
    'DISPID_SCSBaseStream', 'ISpeechRecoResult2',
    'ISpeechObjectTokens', 'DISPID_SPIAudioStreamPosition',
    'SAFTDefault', 'SpeechRegistryLocalMachineRoot', 'SpMMAudioIn',
    'DISPID_SpeechPhraseInfo', 'eLEXTYPE_RESERVED7',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpPhoneticAlphabetSelection',
    'DISPID_SMSALineId', 'SPRST_INACTIVE', 'SPRULE', 'SPPS_RESERVED2',
    'DISPID_SPIStartTime', 'SPRECOGNIZERSTATUS',
    'DISPID_SRCEHypothesis', 'ISpeechLexiconWord',
    'SAFT16kHz16BitMono', 'SDKLLocalMachine', 'SREPropertyNumChange',
    'SDKLCurrentConfig', 'SPSMF_UPS', 'DISPID_SDKDeleteValue',
    'DISPID_SPRuleEngineConfidence', 'SPPS_Noncontent',
    'SRCS_Disabled', 'SPINTERFERENCE_TOOSLOW',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechPhraseElements',
    'DISPID_SpeechPhraseReplacement', 'ISpeechResourceLoader',
    'DISPID_SRGetFormat',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVPause', 'SPRST_ACTIVE_ALWAYS', 'ISpeechMemoryStream',
    'SPSHORTCUTPAIR', 'SPAO_NONE', 'ISpPhrase',
    'DISPID_SPEPronunciation', 'SDTProperty', 'SRSInactive',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRStatus',
    'SECFIgnoreKanaType', 'ISpeechRecoContext', 'ISpRecognizer',
    ...
    'SPLEXICONTYPE', 'SDA_One_Trailing_Space', 'UINT_PTR',
    'SpeechRunState', 'SPVPRI_ALERT', 'DISPID_SWFEChannels',
    'SECLowConfidence', 'SPWT_DISPLAY', 'SPAS_RUN',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SpeechLexiconProns',
    'SINoise', 'SDTAudio', 'DISPID_SLPPartOfSpeech', 'ISpPhraseAlt',
    'ISpeechLexiconPronunciation', 'SAFT32kHz16BitMono',
    'DISPID_SVAudioOutputStream', 'SVSFIsNotXML',
    'DISPID_SOTGetAttribute', 'DISPID_SPERetainedStreamOffset',
    'SVPOver', 'SP_VISEME_12', 'DISPID_SFSOpen', 'SPAR_Medium',
    'SPFM_OPEN_READONLY', 'SPEI_VOICE_CHANGE',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPPs_NewEnum',
    'SGLexical', 'SPAR_Low', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechRecoResultTimes', 'SPSNotOverriden',
    'SAFT24kHz16BitStereo', 'eLEXTYPE_USER', 'SAFTADPCM_11kHzMono',
    'SPGS_EXCLUSIVE', 'SLTUser', 'DISPID_SMSSetData',
    'SAFTGSM610_44kHzMono', 'ISpNotifySource', 'SPSUnknown',
    'SPPHRASEREPLACEMENT', 'SpSharedRecoContext',
    'DISPID_SABufferInfo', 'SAFT16kHz8BitStereo',
    'DISPID_SGRSTPropertyName', 'SPAUDIOBUFFERINFO',
    'DISPID_SRRAudioFormat', 'SpInprocRecognizer', 'SVP_7',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechAudioStatus',
    'SPCT_DICTATION', 'ISpObjectTokenCategory',
    'DISPID_SGRAddResource', 'SAFTGSM610_22kHzMono',
    'SpeechDiscardType', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechTokenKeyAttributes', 'SVEWordBoundary',
    'DISPID_SpeechAudio', 'SPVPRI_OVER', 'SDKLDefaultLocation',
    'SRERecoOtherContext', 'SpeechUserTraining',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechGrammarRuleState',
    'SGDisplay', 'DISPID_SGRAddState', 'SP_VISEME_6',
    'SpSharedRecognizer', 'SGDSActiveWithAutoPause',
    ...
    'DISPID_SPPConfidence', 'DISPID_SVEViseme', 'SPPS_SuppressWord',
    'SAFTCCITT_ALaw_44kHzStereo', 'SRAExport',
    'DISPID_SRGRecoContext', 'DISPID_SASCurrentDevicePosition',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechAudioFormatType',
    'DISPID_SRGState', 'DISPID_SLPsItem', 'SAFTADPCM_44kHzStereo',
    'SpeechStreamFileMode', 'DISPID_SOTId', 'SpeechFormatType',
    'DISPID_SVSLastStreamNumberQueued', 'SpCustomStream',
    'SRTAutopause', 'SPEI_SOUND_START', 'DISPID_SRGDictationSetState',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRsItem',
    'SRTSMLTimeout', 'SAFTADPCM_8kHzStereo',
    'SAFTCCITT_uLaw_11kHzMono', 'SpeechPartOfSpeech',
    'DISPID_SOTsItem', 'SAFTText', 'SBOPause', 'SVSFDefault',
    'SGDSActiveUserDelimited', 'SVP_2', '_RemotableHandle',
    'DISPID_SOTMatchesAttributes', 'DISPID_SAFGetWaveFormatEx',
    'SPWF_INPUT', 'DISPID_SRState', 'DISPID_SpeechAudioFormat',
    'eLEXTYPE_PRIVATE3', 'DISPID_SVVolume', 'SVSFlagsAsync',
    'SRSInactiveWithPurge', 'SpeechMicTraining',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPARecoResult',
    'SpeechLexiconType', 'SpeechVoicePriority', 'SAFT16kHz8BitMono',
    'SINone', 'DISPID_SRCESoundStart',
    'DISPID_SRCEPropertyStringChange', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechLexicon', 'SECFNoSpecialChars',
    'DISPID_SWFEFormatTag', 'DISPID_SABIBufferSize', 'SPPS_RESERVED4',
    'SPPS_Function', 'SAFT8kHz16BitMono',
    'DISPID_SRGSetWordSequenceData', 'SPINTERFERENCE_NONE',
    'ISpRecognizer2', 'SVP_14', 'ISpLexicon',
    'DISPID_SPRuleConfidence', 'SREStreamEnd', 'DISPID_SOTCategory',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechEmulationCompareFlags',
    'SPPS_LMA', 'SFTSREngine', 'DISPID_SPERequiredConfidence',
    'DISPID_SpeechFileStream', 'DISPID_SWFEBlockAlign',
    'SREPhraseStart', 'DISPID_SRCResume', 'DISPIDSPTSI_ActiveOffset',
    'SWTAdded', 'DISPID_SRSCurrentStreamPosition', 'SPCONTEXTSTATE',
    'ISpeechPhraseRules', 'DISPID_SRCEBookmark', 'SREStateChange',
    'DISPID_SGRName', 'SAFTADPCM_44kHzMono', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRGCmdSetRuleIdState', 'SRAInterpreter',
    'SPTEXTSELECTIONINFO',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEI_START_INPUT_STREAM', 'SPSSuppressWord',
    'DISPID_SRCRetainedAudio', 'SGRSTTEpsilon',
    'ISpeechAudioBufferInfo', 'ISpAudio', 'SVSFParseSsml',
    'ISpEventSink', 'DISPID_SLWWord', 'SECFEmulateResult',
    'DISPID_SRCPause', 'SVP_8', 'DISPID_SVStatus',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRCERecognitionForOtherContext', 'SpeechTokenKeyFiles',
    'DISPID_SVEWord', 'DISPID_SGRsCommitAndSave', 'SVPNormal',
    ...
    'SVEBookmark', 'DISPID_SRGetPropertyString'
]

_check_version('1.1.14', 1757486513.240087)
